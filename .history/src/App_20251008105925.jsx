        ...
        <AuthProvider>
          <Router>
            ...
            <Routes>
              ...
              <Route path="/user/thong-bao" element={<UserProfile />} />
              <Route path="/user/favorite" element={<UserFavorites />} />
              <Route path="/user/playlist" element={<UserWatchlist />} />
              <Route path="/user/xem-tiep" element={<UserHistory />} />
