...
const getApiBaseUrl = () => {
  ...
  // Always use relative path to leverage Vite proxy in development
  // This works for both localhost and Dev Tunnels
  if (import.meta.env.DEV) {
    return '/api';
  }
  
  // Check if current origin contains devtunnels (for production builds)
  ...
  // Check if we're on tuphim.online domain
  if (window.location.origin.includes('tuphim.online')) {
    return 'https://api.tuphim.online/api';
  }
