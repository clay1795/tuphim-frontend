...
export const fetchAllMovies = async () => {
  try {
    ...
    const searchEndpoints = [
      'getApiUrl()/movies/search?keyword=a&limit=50000',
      'getApiUrl()/movies/search?keyword=e&limit=50000',
      'getApiUrl()/movies/search?keyword=i&limit=50000'
    ];
    ...
    if (allMovies.length < 10000) {
      ...
      const additionalEndpoints = [
        'getApiUrl()/movies/new?page=1&limit=10000&version=v3',
        'getApiUrl()/movies/new?page=2&limit=10000&version=v3',
        'getApiUrl()/movies/new?page=3&limit=10000&version=v3'
      ];
