...
export const createDetailedMovieSections = async () => {
  ...
  console.log('✅ Got', allMovies.length, 'movies from API');
  ...
  // Định nghĩa các section với bộ lọc đơn giản
  const sectionConfigs = [
    {
      key: 'phim-moi-nhat',
      title: 'Phim Mới Nhất',
      description: 'Những bộ phim mới cập nhật gần đây',
      filterCriteria: {
        years: ['2024', '2023', '2025'],
        sortBy: 'mới cập nhật'
      },
      searchParams: '?years=2024,2023,2025&sortBy=newest',
