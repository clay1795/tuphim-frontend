                ...
                <>
                  <>
                    ...
                    {(() => {
                      ...
                      if (movies.length === 0) {
                        console.log('No movies available, showing empty sections');
                        // Hiển thị các section trống với message
                        const emptySections = [
                          {
                        ...
                        return emptySections.map((section) => {
                      ...
                      try {
                        ...
                        return sections.map((section) => {
                          console.log(`Section "${section.title}":`, section.movies.length, 'movies');
                          const Component = section.component === 'MovieSectionCarousel' ? MovieSectionCarousel : MovieSection;
