...
import { filterMoviesByTheme, filterHighQualityMovies, filterNewMovies, createUniqueMovieSections, createDetailedMovieSections } from "./utils/movieFilters";
              ...
              <Route path="/" element={
                <>
                  <>
                    ...
                    {/* Movie Sections with Unique Movies */}
                    {movies.length > 0 && createUniqueMovieSections(movies).map((section, index) => {
