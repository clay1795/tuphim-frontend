...
import { filterMoviesByTheme, filterHighQualityMovies, filterNewMovies, createUniqueMovieSections } from "./utils/movieFilters";
              ...
              <Route path="/" element={
                <>
                  <>
                    ...
                    {/* Phim Trung Quốc mới */}
                    {movies.length > 0 && <MovieSectionCarousel 
                    ...
                    {movies.length > 0 && <MovieSectionCarousel 
                      ...
                      movies={(() => {
                        ...
                        return animeMovies.length > 0 ? animeMovies.slice(0, 20) : 
                               japaneseMovies.length > 0 ? japaneseMovies.slice(0, 20) : 
                    ...
                    {movies.length > 0 && <MovieSection 
                      ...
                      movies={(() => {
                        ...
                        return americanRomance.length > 0 ? americanRomance.slice(0, 20) : 
                               americanMovies.length > 0 ? americanMovies.slice(0, 20) : 
                    ...
                    {movies.length > 0 && <MovieSection 
                      ...
                      movies={(() => {
                        ...
                        return koreanDetective.length > 0 ? koreanDetective.slice(0, 20) : 
                               koreanMovies.length > 0 ? koreanMovies.slice(0, 20) : 
