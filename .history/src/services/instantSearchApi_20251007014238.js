  ...
  instantSearch: async (keyword = '', options = {}) => {
    try {
      ...
      if (keyword && keyword.trim()) {
        ...
        console.log(`After keyword filter "${keyword}": ${results.length} movies`);
      }
      ...
      if (options.category && options.category.trim()) {
        ...
        console.log(`After category filter "${options.category}": ${results.length} movies`);
      }
      ...
      if (options.country && options.country.trim()) {
        ...
        console.log(`After country filter "${options.country}": ${results.length} movies`);
      }
      ...
      if (options.year && options.year.toString().trim()) {
        ...
        if (!isNaN(yearValue)) {
          ...
          console.log(`After year filter "${options.year}": ${results.length} movies`);
        }
      }
      ...
      if (options.type && options.type.trim()) {
        ...
        console.log(`After type filter "${options.type}": ${results.length} movies`);
      }
  ...
  extendedSearch: async (keyword = '', options = {}) => {
    try {
      ...
      if (keyword && keyword.trim()) {
        ...
        console.log(`Extended search - After keyword filter "${keyword}": ${results.length} movies`);
      }
      ...
      if (options.category && options.category.trim()) {
        ...
        console.log(`Extended search - After category filter "${options.category}": ${results.length} movies`);
      }
      ...
      if (options.country && options.country.trim()) {
        ...
        console.log(`Extended search - After country filter "${options.country}": ${results.length} movies`);
      }
      ...
      if (options.year && options.year.toString().trim()) {
        ...
        if (!isNaN(yearValue)) {
          ...
          console.log(`Extended search - After year filter "${options.year}": ${results.length} movies`);
        }
      }
      ...
      if (options.type && options.type.trim()) {
        ...
        console.log(`Extended search - After type filter "${options.type}": ${results.length} movies`);
      }
