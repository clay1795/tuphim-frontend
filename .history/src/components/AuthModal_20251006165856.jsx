...
const AuthModal = ({ isOpen, onClose }) => {
  ...
  // Handle ESC key to close modal and scroll lock
  useEffect(() => {
    ...
    if (isOpen) {
      ...
      // Restore body scroll and position when modal is closed
  ...
  return (
    <div 
      ...
      style={{
        ...
        padding: '1rem',
        // Modal xuất hiện tại vị trí cuộn hiện tại
    ...
    >
      ...
      <div 
        ...
        style={{
          ...
          width: '100%',
          height: `calc(100% + ${scrollOffset * 2}px)`
        }}
      ></div>
      
      {/* Modal Content */}
      <div 
        className="relative bg-gray-900 rounded-lg shadow-2xl w-full max-w-md mx-4 max-h-[90vh] overflow-y-auto"
        style={{
          position: 'relative',
          zIndex: 1
        }}
