        ...
        <div className="container mx-auto px-6 py-8">
          <div className="text-center space-y-4">
            ...
            <p className="text-gray-300 text-lg">
              Khám phá phim với bộ lọc thông minh
            </p>
        ...
        <div className="space-y-6">
          ...
          {loading ? (
            <div className="relative">
              {/* Loading overlay */}
              <div className="absolute inset-0 bg-gradient-to-r from-transparent via-gray-800/10 to-transparent animate-shimmer"></div>
              
              {/* Enhanced skeleton grid */}
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-4">
                {Array.from({ length: 24 }).map((_, index) => (
                  <SkeletonLoader key={index} type="single" />
                ))}
              </div>
              ...
              <div className="text-center py-6">
                <div className="inline-flex items-center space-x-3 text-gray-400">
                  ...
                  <span className="text-sm font-medium">Đang tải từ cache...</span>
                </div>
              </div>
            </div>
          ) : movies.length > 0 ? (
