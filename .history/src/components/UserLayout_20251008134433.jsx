      ...
      <div className="max-w-8xl mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
          ...
          <div className="lg:col-span-1">
            <div className="bg-gray-800 rounded-xl p-6 fixed top-60 left-8 w-64 border-r border-gray-600 max-h-[calc(100vh-200px)] overflow-y-auto">
              <div className="mb-8">
          ...
          {/* Main Content */}
          <div className="lg:col-span-4 ml-65">
            <Outlet />
          </div>
        </div>
      </div>
