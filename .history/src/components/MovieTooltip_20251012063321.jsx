      ...
      {isVisible && (
        ...
        >
          ...
          <div className="relative h-56 overflow-hidden cursor-pointer animate-in slide-in-from-top-2 duration-500 delay-100">
            {!isImageLoaded && !imageLoadError && (
              <div className="w-full h-full bg-gray-800 flex items-center justify-center">
                <div className="flex flex-col items-center space-y-2">
                  ...
                  <span className="text-yellow-400 text-xs">Đang tải ảnh...</span>
                </div>
              </div>
            )}
            ...
            {imageLoadError && (
              <div 
                className="absolute inset-0 w-full h-full bg-gradient-to-br from-gray-700 via-gray-800 to-gray-900 flex items-center justify-center"
                style={{
