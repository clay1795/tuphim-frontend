    ...
    try {
      ...
      if (data.items && data.items.length > 0) {
        ...
        console.log('Suggested movies image URLs:', suggestions.map(m => ({
          ...
          optimized_url: getOptimizedImageUrl(m.poster_url || m.thumb_url)
        })));
  ...
  return (
    <>
      ...
      <section className="relative h-[80vh] min-h-[600px] -mt-20">
        ...
        <img
          src={getOptimizedImageUrl(featuredMovie.poster_url || featuredMovie.thumb_url)}
          ...
          onError={(e) => {
            console.log('Featured movie image error:', featuredMovie.name, 'URL:', featuredMovie.poster_url || featuredMovie.thumb_url);
