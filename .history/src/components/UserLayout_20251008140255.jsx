      ...
      <div className="max-w-8xl mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
          ...
          <div className="lg:col-span-1">
            <div className="bg-gray-800 rounded-xl p-6 fixed top-60 left-8 w-56 border-r border-gray-600 max-h-[calc(100vh-150px)] overflow-y-auto">
              {/* Logo RoPhim */}
              <div className="mb-6">
                <div className="flex items-center space-x-2 mb-4">
                  ...
                  <span className="text-white font-bold text-lg">RoPhim</span>
                </div>
