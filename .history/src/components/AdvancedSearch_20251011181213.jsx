    ...
    try {
      ...
      try {
        ...
        if (newFilters.keyword) {
          ...
          const searchResult = await simpleMovieApi.searchMovies(newFilters.keyword, searchOptions);
          data = {
            items: searchResult.data?.items || searchResult.items || [],
            totalItems: searchResult.data?.totalItems || searchResult.totalItems || 0,
            totalPages: searchResult.data?.totalPages || searchResult.totalPages || 1,
            instant: false,
            extended: true,
            fullDatabase: false
          };
          ...
          data = {
            items: newMoviesResult.data?.items || newMoviesResult.items || [],
            totalItems: newMoviesResult.data?.pagination?.totalItems || newMoviesResult.totalItems || 0,
            totalPages: newMoviesResult.data?.pagination?.totalPages || newMoviesResult.totalPages || 1,
            instant: false,
            extended: false,
            fullDatabase: false
          };
