...
const UserLayout = () => {
  ...
  return (
    <div className="flex min-h-screen bg-[#0d1017] text-white">
      {/* Sidebar */}
      <aside className="w-56 bg-[#11151a] text-white p-6 flex flex-col justify-between max-h-screen overflow-y-auto">
        <div>
        ...
        {/* User Summary */}
        <div className="mt-6 border-t border-[#1f2430] pt-4 text-sm">
