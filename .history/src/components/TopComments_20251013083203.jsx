            ...
            {loadingComments ? (
              <div style={{
                ...
                <div style={{
                  ...
                  <i className="fa-solid fa-film" style={{ fontSize: '20px', color: '#666' }}></i>
                </div>
                <div style={{
                  display: 'flex',
              ...
              <article key={comment.id} style={{
                  ...
                  <div style={{
                    ...
                    <div style={{
                      ...
                      <img 
                        ...
                        onError={(e) => {
                          e.target.src = 'https://via.placeholder.com/24x24/666/ffffff?text=U';
                        }}
                      />
                      <div style={{
                        fontSize: '13px',
                ...
                <div style={{
                  ...
                  <img 
                    ...
                    onError={(e) => {
                      e.target.src = 'https://via.placeholder.com/90x110/2a2a2a/ffffff?text=No+Image';
                    }}
                  />
                </div>
              </article>
