      ...
      <div className="max-w-8xl mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
          ...
          <div className="lg:col-span-1">
            <div className="bg-gray-800 rounded-xl p-6 fixed top-60 left-6 w-56 border-r border-gray-600 max-h-[calc(100vh-150px)] overflow-y-auto">
              {/* Logo RoPhim */}
              <div className="mb-6">
          ...
          {/* Main Content */}
          <div className="lg:col-span-4 ml-64 pl-6">
            <Outlet />
          </div>
        </div>
      </div>
