...
if (typeof document !== 'undefined') {
  ...
  // Add global tooltip override
  const globalTooltipStyle = document.getElementById('global-tooltip-override');
  if (!globalTooltipStyle) {
    const globalStyle = document.createElement('style');
    globalStyle.id = 'global-tooltip-override';
    globalStyle.textContent = `
      ...
      /* Override any potential stacking context conflicts */
      * {
