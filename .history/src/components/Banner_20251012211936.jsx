      ...
      <section className="relative h-[50vh] sm:h-[60vh] md:h-[70vh] lg:h-[80vh] min-h-[380px] sm:min-h-[420px] md:min-h-[500px] lg:min-h-[600px] -mt-16 sm:-mt-20 banner-hero">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-black/70 via-black/40 to-black/10"></div>
               ...
               <div className="relative h-full">
                 ...
                 <div className="lg:hidden absolute bottom-4 left-4 right-4 z-20">
                   <div className="flex justify-center space-x-2">
                     {suggestedMovies.slice(0, 6).map((movie, index) => (
                       ...
                       >
                         <div className="relative w-12 h-8 rounded overflow-hidden border border-white/50 hover:border-yellow-400 transition-all duration-300 group-hover:scale-110 bg-gray-800 shadow-lg backdrop-blur-sm">
                           <img
                 ...
                 <div className="hidden lg:block absolute left-3 sm:left-6 bottom-12 right-6 z-20">
                   <div className="flex justify-between items-center">
                     ...
                     {suggestedMovies.slice(0, 6).map((movie, index) => (
                       ...
                       >
                         <div className="relative w-20 h-12 rounded overflow-hidden border border-white/50 hover:border-yellow-400 transition-all duration-300 group-hover:scale-110 bg-gray-800 shadow-lg backdrop-blur-sm">
                           <img
                             src={movie.thumbnail_url || movie.thumb_url || getOptimizedImageUrl(movie.poster_url)}
                             alt={movie.name}
                             className="w-full h-full object-cover object-center"
                     ...
                     {/* Play Button - Same level as suggested movies */}
                     <div className="flex items-center space-x-2">
                       <Link
                         to={`/phim/${featuredMovie.slug || featuredMovie._id}`}
                         className="w-12 h-12 rounded-full bg-gradient-to-r from-yellow-400 to-yellow-500 hover:from-yellow-500 hover:to-yellow-600 
                                   flex items-center justify-center shadow-lg hover:shadow-yellow-500/25 transition-all duration-300 hover:scale-105 touch-target"
                       >
                       ...
                       <button 
                         onClick={() => handleAddToFavorites(featuredMovie)}
                         className="w-10 h-10 rounded-full bg-gray-800/60 backdrop-blur-sm border border-gray-600/50 hover:bg-white/10 transition-colors duration-300 flex items-center justify-center touch-target"
                         title="Thêm vào yêu thích"
                       >
