...
const UserHistory = () => {
  ...
  // Debug info
  console.log('UserHistory render - user:', user, 'loading:', loading, 'history length:', history.length);

  return (
    <>
      <div className="flex items-center justify-between mb-8">
        <h2 className="text-2xl font-bold text-white">Xem tiếp</h2>
        <span className="text-gray-400">{history.length} phim • Trang {currentPage}/{totalPages}</span>
      </div>
