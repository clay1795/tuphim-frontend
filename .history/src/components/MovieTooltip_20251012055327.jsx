        ...
        >
          ...
          <div className="p-4 space-y-3">
            ...
            <div className="flex items-end space-x-2">
              {/* Xem ngay button - Yellow, wider */}
              <Link
                to={`/phim/${enhancedMovie.slug || enhancedMovie.movieSlug || enhancedMovie._id || enhancedMovie.movieId}`}
                className="flex-1 bg-yellow-500 hover:bg-yellow-600 text-black font-bold py-3 px-4 rounded-lg transition-colors duration-200 flex items-center justify-center space-x-2"
              ...
              {/* Thích button - Gray, rounded */}
              <button 
                onClick={handleAddToFavorites}
                className="bg-gray-700 hover:bg-gray-600 text-white font-medium py-3 px-4 rounded-lg border border-gray-600 transition-colors duration-200 flex items-center justify-center space-x-2"
