  ...
  return (
    <>
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-3xl font-bold text-white mb-2">Danh sách xem sau</h1>
          <p className="text-gray-400">Danh sách phim bạn muốn xem sau này</p>
        </div>
        <div className="text-right">
          <div className="text-2xl font-bold text-yellow-400">{watchlist.length}</div>
          <div className="text-sm text-gray-400">phim trong danh sách</div>
        </div>
      </div>
