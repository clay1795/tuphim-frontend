          ...
          {loading ? (
            <div className="flex justify-center items-center py-16">
              <div className="luxury-loader">
                <div className="luxury-spinner luxury-spinner-lg">
                  <div className="luxury-ring luxury-ring-outer"></div>
                  <div className="luxury-ring luxury-ring-inner"></div>
                  <div className="luxury-core luxury-core-lg"></div>
                </div>
                <div className="luxury-text luxury-text-lg">Đang tải dữ liệu...</div>
              </div>
            </div>
          ) : movies.length > 0 ? (
