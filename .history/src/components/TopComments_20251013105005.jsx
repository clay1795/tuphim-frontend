    ...
    <>
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '28px 16px' }}>
        ...
        <div style={{
          ...
          {/* YÊU THÍCH NHẤT */}
          <section style={{
            background: 'radial-gradient(400px 200px at 50% 0%, rgba(26, 27, 35, 0.8) 0%, rgba(11, 12, 19, 0.9) 100%)',
            border: '1px solid rgba(32, 33, 43, 0.6)',
            borderRadius: '14px',
            boxShadow: '0 2px 10px rgba(0, 0, 0, 0.2), inset 0 1px 0 rgba(255, 255, 255, 0.03)',
            padding: '18px',
            ...
            <h2 style={{
             ...
             {loadingComments ? (
              <div style={{
               ...
               (showAllComments ? topComments : topComments.slice(0, 3)).map((comment) => (
