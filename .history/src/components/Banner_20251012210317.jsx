      ...
      <section className="relative h-[50vh] sm:h-[60vh] md:h-[70vh] lg:h-[80vh] min-h-[380px] sm:min-h-[420px] md:min-h-[500px] lg:min-h-[600px] -mt-16 sm:-mt-20 banner-hero">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-black/70 via-black/40 to-black/10"></div>
               ...
               <div className="relative h-full">
                 ...
                 <div className="hidden lg:block absolute bottom-6 right-6 z-20 banner-suggestions">
                   <div className="bg-black/80 backdrop-blur-lg rounded-xl p-3 border border-white/30 shadow-2xl">
                     <h3 className="text-white text-xs font-semibold mb-2 text-center">Đề xuất cho bạn</h3>
                     <div className="flex space-x-1.5 justify-center">
                       {suggestedMovies.slice(0, 6).map((movie, index) => (
                         ...
                         >
                           <div className="relative w-14 h-9 rounded overflow-hidden border border-white/30 hover:border-yellow-400 transition-all duration-300 group-hover:scale-110 bg-gray-800 shadow-lg">
                             <img
