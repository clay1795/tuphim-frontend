     ...
     try {
      ...
      try {
        ...
        data = result.data;
          ...
          console.log('Using general search with MongoDB API');
          // MongoDB API handles all cases including category, country, year, type filters
          const result = await mongoMovieApi.searchMovies('', searchOptions);
          data = result.data;
