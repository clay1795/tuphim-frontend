                     ...
                     <div className="flex space-x-1">
                       {suggestedMovies.slice(0, 3).map((movie, index) => (
                         <div
                           ...
                           className="relative w-14 h-18 rounded-lg overflow-hidden border border-white/30 hover:border-yellow-400 transition-all duration-300 cursor-pointer group hover:scale-110 bg-gray-800"
                         >
                           <img
