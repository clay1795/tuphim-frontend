...
const UserLayout = () => {
  ...
  return (
    <div className="flex min-h-screen bg-[#0d1017] text-white">
      {/* Sidebar */}
      <aside className="w-56 bg-[#11151a] text-white p-6 flex flex-col justify-between h-screen">
        <div>
        ...
        {/* User Summary */}
        <div className="mt-6 border-t border-[#1f2430] pt-6 text-sm">
          <div className="flex items-center space-x-3 mb-3">
            ...
            />
            <div>
              <p className="font-medium">{user.fullName || user.username || 'Người dùng'}</p>
