          ...
          <div className="p-4 space-y-3">
            ...
            <div className="flex items-end space-x-2">
              ...
              <Link
                ...
                className="flex-grow bg-yellow-500 hover:bg-yellow-600 text-black font-bold py-3 px-6 rounded-lg transition-colors duration-200 flex items-center justify-center space-x-2"
