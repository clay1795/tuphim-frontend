...
const AuthModal = ({ isOpen, onClose }) => {
  ...
  return (
    <>
      ...
      <div 
        className={`fixed inset-0 bg-black/60 modal-backdrop z-[99998] transition-opacity duration-300 ${
      ...
      >
        ...
        <div 
          className={`relative bg-gray-900 rounded-lg shadow-2xl w-full max-w-md mx-4 max-h-[90vh] overflow-y-auto transition-all duration-400 cubic-bezier(0.25, 0.46, 0.45, 0.94) transform ${
            isOpen && isAnimating 
