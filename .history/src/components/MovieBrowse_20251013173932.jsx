  ...
  const loadMovies = async (page = 1, newFilters = filters) => {
    ...
    try {
      ...
      if (hasFilters) {
        ...
        // Use MongoDB series-grouped movies API (only latest parts of series)
        console.log('Using MongoDB series-grouped movies API');
        const result = await mongoMovieApi.getSeriesGroupedMovies(page, 24);
        data = result.data;
      }
