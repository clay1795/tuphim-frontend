...
const AdvancedSearch = () => {
  ...
  // Kkphim.com style sorting options
  const sortOptions = [
    { value: 'modified_time', label: 'Mới cập nhật', apiValue: 'modified_time' },
    { value: 'created_time', label: 'Thời gian đăng', apiValue: 'created_time' },
    { value: 'year', label: 'Năm sản xuất', apiValue: 'year' }
  ];
    ...
    <div className="min-h-screen bg-gray-900 text-white">
      ...
      <div className="bg-gray-800 border-b border-gray-700">
        <div className="container mx-auto px-6 py-8">
              ...
              onClick={async () => {
                ...
                try {
                  ...
                  if (data.items && data.items.length > 0) {
                    ...
                    console.log('Sample movies with type fields:', sample.map(movie => ({
                      name: movie.name,
                      type: movie.type,
          ...
          {(filters.keyword || filters.category || filters.country || filters.year || filters.type) && (
            <div className="mt-4 p-3 bg-gray-800/50 border border-gray-700 rounded-lg">
              <div className="flex items-center justify-between mb-2">
                ...
                <button
                  onClick={() => {
                    setFilters({ ...filters, keyword: '', category: '', country: '', year: '', type: '' });
                    performSearch(1, { ...filters, keyword: '', category: '', country: '', year: '', type: '' }, searchMode);
                  }}
