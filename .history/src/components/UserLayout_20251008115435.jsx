        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="bg-gray-800 rounded-2xl p-6 sticky top-8">
              <div className="mb-6">
                <h3 className="text-lg font-semibold text-white mb-1">Quản lý tài khoản</h3>
              ...
              <div className="mt-8 pt-6 border-t border-gray-700">
                ...
                <button className="w-full flex items-center justify-center space-x-2 px-4 py-2 bg-gray-700 hover:bg-gray-600 text-white rounded-lg transition-colors">
