            ...
            try {
              ...
              if (commentResponse.success && commentResponse.data.length > 0) {
                ...
                commentResponse.data.forEach(comment => {
                  ...
                  const optimizedUrl = movie ? getOptimizedImageUrl(movie) : 'https://via.placeholder.com/100x150/333/fff?text=Movie';
                  
                  allComments.push({
                    id: comment._id,
                    user: comment.username || 'User',
                    userInfo: '∞',
                    avatar: comment.avatar || (movie ? getRealAvatarFromApi(movie, 0) : 'https://via.placeholder.com/32x32/007bff/fff?text=' + (comment.username?.charAt(0) || 'U')),
                    poster: optimizedUrl,
