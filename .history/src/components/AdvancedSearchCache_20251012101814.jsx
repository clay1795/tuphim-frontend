...
const AdvancedSearchCache = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black">
      ...
      <div className="container mx-auto px-6 py-12">
        <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 shadow-2xl animate-slide-up hover:bg-white/10 transition-all duration-500">
          <form className="space-y-8">
            ...
            <div className="relative">
              <label className="text-white font-bold mb-4 text-xl flex items-center gap-3">
              ...
              <div className="space-y-8 pt-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                  ...
                  <div className="space-y-3 animate-fade-in-up">
                    ...
                    <div className="relative group">
                      <div className="absolute inset-0 bg-gradient-to-r from-red-500/10 to-purple-500/10 rounded-xl blur-sm group-hover:blur-md transition-all duration-500"></div>
                      <select
                        value={filters.category}
                        onChange={(e) => handleFilterChange('category', e.target.value)}
                        className="relative w-full px-4 py-3 bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl text-white focus:outline-none focus:ring-2 focus:ring-red-500/50 focus:border-red-400/50 transition-all duration-500 hover:bg-white/15 appearance-none cursor-pointer"
                        disabled={loadingFilters}
                      >
                        <option value="" className="bg-gray-800">Tất cả thể loại</option>
                  ...
                  <div className="space-y-3 animate-fade-in-up" style={{animationDelay: '0.1s'}}>
                    ...
                    <div className="relative group">
                      <div className="absolute inset-0 bg-gradient-to-r from-blue-500/10 to-cyan-500/10 rounded-xl blur-sm group-hover:blur-md transition-all duration-500"></div>
                      <select
                        value={filters.country}
                        onChange={(e) => handleFilterChange('country', e.target.value)}
                        className="relative w-full px-4 py-3 bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl text-white focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-400/50 transition-all duration-500 hover:bg-white/15 appearance-none cursor-pointer"
                        disabled={loadingFilters}
                      >
                        <option value="" className="bg-gray-800">Tất cả quốc gia</option>
                  ...
                  <div className="space-y-3 animate-fade-in-up" style={{animationDelay: '0.2s'}}>
                    ...
                    <div className="relative group">
                      <div className="absolute inset-0 bg-gradient-to-r from-green-500/10 to-emerald-500/10 rounded-xl blur-sm group-hover:blur-md transition-all duration-500"></div>
                      <select
                        value={filters.year}
                        onChange={(e) => handleFilterChange('year', e.target.value)}
                        className="relative w-full px-4 py-3 bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl text-white focus:outline-none focus:ring-2 focus:ring-green-500/50 focus:border-green-400/50 transition-all duration-500 hover:bg-white/15 appearance-none cursor-pointer"
                      >
                        <option value="" className="bg-gray-800">Tất cả năm</option>
                        {years.map((year) => (
                  ...
                  <div className="space-y-3 animate-fade-in-up" style={{animationDelay: '0.3s'}}>
                    ...
                    <div className="relative group">
                      <div className="absolute inset-0 bg-gradient-to-r from-purple-500/10 to-pink-500/10 rounded-xl blur-sm group-hover:blur-md transition-all duration-500"></div>
                      <select
                        value={filters.type}
                        onChange={(e) => handleFilterChange('type', e.target.value)}
                        className="relative w-full px-4 py-3 bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl text-white focus:outline-none focus:ring-2 focus:ring-purple-500/50 focus:border-purple-400/50 transition-all duration-500 hover:bg-white/15 appearance-none cursor-pointer"
                      >
                        <option value="" className="bg-gray-800">Tất cả loại</option>
                        {types.map((type) => (
                ...
                {/* Beautiful Sort Section */}
                <div className="flex flex-col lg:flex-row gap-6 items-start lg:items-end animate-fade-in-up" style={{animationDelay: '0.4s'}}>
                  <div className="space-y-3 flex-1">
                    ...
                    <div className="relative group">
                      <div className="absolute inset-0 bg-gradient-to-r from-yellow-500/10 to-orange-500/10 rounded-xl blur-sm group-hover:blur-md transition-all duration-500"></div>
                      <select
                        ...
                        className="relative w-full px-4 py-3 bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl text-white focus:outline-none focus:ring-2 focus:ring-yellow-500/50 focus:border-yellow-400/50 transition-all duration-500 hover:bg-white/15 appearance-none cursor-pointer"
                      >
                  ...
                  {/* Beautiful Clear Filters Button */}
                  <button
                    type="button"
                    onClick={() => {
                    ...
                    className="group relative px-8 py-4 bg-gradient-to-r from-red-500 to-pink-600 hover:from-red-600 hover:to-pink-700 text-white font-bold rounded-2xl transition-all duration-500 transform hover:scale-105 shadow-2xl hover:shadow-red-500/30 flex items-center gap-3 overflow-hidden"
                  >
                    <div className="absolute inset-0 bg-gradient-to-r from-white/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                    <span className="relative text-2xl">🔄</span>
                    <span className="relative text-lg">Xóa Bộ Lọc</span>
                  </button>
                </div>
              </div>
            </div>
      ...
      {/* Beautiful Results Section with Glassmorphism */}
      <div className="container mx-auto px-6 pb-20">
        {loading ? (
          <div className="space-y-12 animate-fade-in">
            {/* Beautiful Loading Header */}
            <div className="flex justify-center">
              <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl px-10 py-6 shadow-2xl">
                <div className="flex items-center gap-4">
                  <div className="relative">
                    <div className="animate-spin rounded-full h-8 w-8 border-4 border-red-400/30 border-t-red-400"></div>
                    <div className="absolute inset-0 animate-ping rounded-full h-8 w-8 border-2 border-red-400/20"></div>
                  </div>
                  <span className="text-white font-bold text-xl">Đang tải phim...</span>
                </div>
              </div>
            </div>
          ...
          <div className="space-y-12 animate-fade-in">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6">
              <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl px-8 py-6 shadow-2xl">
                <h2 className="text-3xl font-bold bg-gradient-to-r from-white to-red-200 bg-clip-text text-transparent flex items-center gap-3">
              ...
              <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl px-6 py-4 shadow-2xl">
                <span className="text-white text-lg font-bold">
                  Trang <span className="text-red-400">{currentPage}</span> / <span className="text-blue-400">{totalPages}</span>
                </span>
              </div>
            </div>

            {/* Beautiful Movies Grid */}
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-6 relative" style={{ zIndex: 1 }}>
              {movies.map((movie, index) => (
                ...
                >
                  <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-2 shadow-xl hover:shadow-2xl hover:bg-white/10 transition-all duration-500">
                ...
                <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl p-6 shadow-2xl">
                  <div className="flex items-center gap-3">
                    <button
                      ...
                      className="px-6 py-3 bg-white/10 hover:bg-white/20 disabled:opacity-50 disabled:cursor-not-allowed text-white rounded-xl transition-all duration-500 transform hover:scale-105 disabled:hover:scale-100 border border-white/20 font-bold"
                    >
                      ← Trước
                    </button>
                    ...
                    {Array.from({ length: Math.min(5, totalPages) }, (_, i) => {
                      ...
                      return (
                        <button
                          ...
                          className={`px-6 py-3 rounded-xl transition-all duration-500 transform hover:scale-105 font-bold ${
                            page === currentPage
                              ? 'bg-gradient-to-r from-red-500 to-purple-600 text-white shadow-2xl border border-red-400/50'
          ...
          <div className="text-center py-24 animate-fade-in">
            <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-3xl p-16 max-w-3xl mx-auto shadow-2xl">
              ...
              <div className="bg-gradient-to-r from-red-500/20 to-purple-500/20 border border-red-500/30 rounded-2xl p-8 backdrop-blur-sm">
      ...
      {/* Beautiful Custom CSS for animations */}
      <style>{`
        @keyframes fade-in {
          from { opacity: 0; }
          to { opacity: 1; }
        ...
        @keyframes pulse-glow {
          ...
          50% {
            text-shadow: 0 0 30px rgba(255, 255, 255, 0.8), 0 0 40px rgba(239, 68, 68, 0.3);
          }
        }
