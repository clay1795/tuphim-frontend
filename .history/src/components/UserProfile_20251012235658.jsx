      ...
      <div className="max-w-7xl mx-auto px-2 sm:px-4">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-xl sm:rounded-2xl p-4 sm:p-6 md:p-8 shadow-xl sm:shadow-2xl border border-gray-700">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                ...
                {/* Display Name Field */}
                <div>
                  <label className="block text-white text-sm font-medium mb-2 sm:mb-3">Tên hiển thị</label>
                  <div className="relative">
                    <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                      <svg className="h-4 w-4 sm:h-5 sm:w-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <input
                      ...
                      className="w-full pl-9 sm:pl-10 pr-3 sm:pr-4 py-2.5 sm:py-3 bg-gray-700 border border-gray-600 rounded-lg sm:rounded-xl text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-yellow-400 focus:border-transparent text-sm sm:text-base"
                ...
                {/* Gender Field */}
                <div>
                  <label className="block text-white text-sm font-medium mb-2 sm:mb-3">Giới tính</label>
                  <div className="grid grid-cols-3 gap-1.5 sm:gap-2">
                    <label className="flex items-center justify-center p-2 sm:p-3 bg-gray-700 border border-gray-600 rounded-lg sm:rounded-xl cursor-pointer hover:bg-gray-600 transition-colors touch-target">
                      <input
                        type="radio"
                        name="gender"
                        value="male"
                        ...
                        className="sr-only"
                      />
                      <span className="text-white text-xs sm:text-sm">Nam</span>
                    </label>
                    <label className="flex items-center justify-center p-2 sm:p-3 bg-gray-700 border border-gray-600 rounded-lg sm:rounded-xl cursor-pointer hover:bg-gray-600 transition-colors touch-target">
                      <input
                        type="radio"
                        ...
                        className="sr-only"
                      />
                      <span className="text-white text-xs sm:text-sm">Nữ</span>
                    </label>
                    <label className="flex items-center justify-center p-2 sm:p-3 bg-gray-700 border border-gray-600 rounded-lg sm:rounded-xl cursor-pointer hover:bg-gray-600 transition-colors touch-target">
                      <input
                        type="radio"
                        ...
                        className="sr-only"
                      />
                      <span className="text-white text-xs sm:text-sm">Khác</span>
                    </label>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-6 sm:mt-8 space-y-3 sm:space-y-4">
                <button
                  ...
                  className="w-full bg-gradient-to-r from-yellow-500 to-orange-500 hover:from-yellow-600 hover:to-orange-600 text-black font-bold py-3 sm:py-4 px-4 sm:px-6 rounded-lg sm:rounded-xl transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 touch-target"
                >
                  <div className="flex items-center justify-center space-x-2">
                    <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                    </svg>
                    <span className="text-sm sm:text-base">Cập nhật thông tin</span>
                  </div>
                </button>
                ...
                <div>
                  ...
                  {tabLoading ? (
                    <div className="text-center py-12">
                      <div className="luxury-spinner luxury-spinner-sm mx-auto mb-4">
                        <div className="luxury-ring luxury-ring-outer"></div>
                        <div className="luxury-ring luxury-ring-middle"></div>
                        <div className="luxury-ring luxury-ring-inner"></div>
        ...
        {showChangePassword && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-2 sm:p-4">
            <div className="bg-gray-800 rounded-xl sm:rounded-2xl p-4 sm:p-6 md:p-8 w-full max-w-sm sm:max-w-md mx-2 sm:mx-4 max-h-[90vh] overflow-y-auto">
              <h3 className="text-lg sm:text-xl font-bold text-white mb-4 sm:mb-6">Đổi mật khẩu</h3>
              ...
              <form onSubmit={handleChangePassword} className="space-y-3 sm:space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 sm:px-4 py-2.5 sm:py-3 bg-gray-700 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-yellow-400 focus:border-transparent text-sm sm:text-base touch-target"
                    required
                  />
                </div>
                ...
                {avatarCategories[selectedCategory]?.map((avatar, index) => (
                  <button
                    ...
                    className={`w-full aspect-square rounded-lg overflow-hidden border-2 transition-all ${
                      selectedAvatar === avatar ? 'border-red-500 ring-2 ring-yellow-400' : 'border-gray-600 hover:border-gray-400'
                    }`}
                  >
                    <img 
                      src={avatar} 
