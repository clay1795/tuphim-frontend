...
const MovieTooltip = ({ movie, children }) => {
  ...
  const updatePosition = () => {
    if (triggerRef.current && tooltipRef.current) {
      ...
      // Center tooltip directly over the movie poster
  ...
  return (
    <div className="relative inline-block">
      ...
      {isVisible && createPortal(
        <div
          ref={tooltipRef}
          className="fixed w-96 rounded-xl shadow-2xl overflow-hidden movie-tooltip hover-lift"
          style={{
            left: `${position.x}px`,
            top: `${position.y}px`,
            pointerEvents: 'auto',
            zIndex: 2147483647,
            animation: 'tooltipZoomIn 0.3s cubic-bezier(0.25, 0.46, 0.45, 0.94) forwards',
            ...
            <div>
              ...
              {isLoadingDetails && (
                <div className="flex items-center space-x-2 mt-2">
                  <div className="animate-spin w-4 h-4 border-2 border-gray-700 border-t-red-500 rounded-full"></div>
...
const tooltipStyles = `
  ...
  .movie-tooltip {
    animation: tooltipZoomIn 0.3s cubic-bezier(0.25, 0.46, 0.45, 0.94) forwards, 
               tooltipPulse 0.6s cubic-bezier(0.25, 0.46, 0.45, 0.94) 0.1s forwards;
  ...
  .movie-tooltip.fade-out {
    animation: tooltipZoomOut 0.25s cubic-bezier(0.4, 0, 0.2, 1) forwards;
  }
