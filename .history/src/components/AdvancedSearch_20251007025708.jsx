  ...
  useEffect(() => {
    ...
    const initializeSearch = async () => {
      try {
        ...
        // Initialize database manager (will auto-download if needed)
        const dbResult = await databaseManager.initialize();
        
        if (dbResult.success) {
          console.log('✅ Database Manager initialized:', dbResult);
          setFullDatabaseLoading(false);
          ...
          throw new Error(dbResult.error || 'Failed to initialize database manager');
        }
