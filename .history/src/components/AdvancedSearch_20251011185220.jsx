...
const AdvancedSearch = () => {
  ...
  const performSearch = async (page = 1, newFilters = filters, mode = searchMode) => {
    try {
      setLoading(true);
      console.log('=== INSTANT FILTERING CALLED ===');
      console.log('Filtering with:', newFilters, 'mode:', mode);
  ...
  const performInstantFilter = (newFilters) => {
    ...
    const filteredMovies = movieDatabase.filterMovies(newFilters);
