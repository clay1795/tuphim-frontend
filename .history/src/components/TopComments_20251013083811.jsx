            ...
            {loadingComments ? (
              <div style={{
                ...
                <div style={{
                  ...
                  <i className="fa-solid fa-film" style={{ fontSize: '16px', color: '#666' }}></i>
                </div>
            </div>
            ) : (
              ...
              <article key={comment.id} style={{
                ...
                <div style={{
                  ...
                  <div style={{
                    ...
                    <div style={{
                      ...
                      <img 
                        ...
                        onError={(e) => {
                          e.target.src = 'https://via.placeholder.com/48x48/666/ffffff?text=U';
                        }}
                      />
                      <div style={{
                        fontSize: '18px',
                  ...
                  <div style={{
                    ...
                    <span style={{
                      ...
                      <i className="fa-solid fa-thumbs-up" style={{ 
                        color: '#4caf50',
                        fontSize: '12px'
                      }}></i> 
                      {comment.upvotes}
                    ...
                    <span style={{
                      ...
                      <i className="fa-solid fa-thumbs-down" style={{ 
                        color: '#e91e63',
                        fontSize: '12px'
                      }}></i> 
                      {comment.downvotes}
                ...
                <div style={{
                  ...
                  <img 
                    ...
                    onError={(e) => {
                      e.target.src = 'https://via.placeholder.com/120x180/2a2a2a/ffffff?text=No+Image';
                    }}
                  />
                </div>
              </article>
