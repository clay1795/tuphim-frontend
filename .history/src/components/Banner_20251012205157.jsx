...
const Banner = ({ onFeaturedMovieChange }) => {
  ...
  return (
    <>
      ...
      <section className="relative h-[50vh] sm:h-[60vh] md:h-[70vh] lg:h-[80vh] min-h-[350px] sm:min-h-[400px] md:min-h-[500px] lg:min-h-[600px] -mt-16 sm:-mt-20 banner-hero">
               ...
               <div className="relative h-full">
                 ...
                 <div className="lg:hidden absolute bottom-0 left-0 right-0 z-20 bg-gradient-to-t from-black/90 via-black/70 to-transparent">
                   <div className="px-3 py-4">
                     ...
                     <div className="flex overflow-x-auto scrollbar-hide space-x-3 pb-2" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
                       {suggestedMovies.slice(0, 6).map((movie, index) => (
                         ...
                         >
                           <div className="relative w-24 h-36 rounded-lg overflow-hidden border-2 border-white/20 hover:border-yellow-400 transition-all duration-300 group-hover:scale-105 bg-gray-800">
                             <img
