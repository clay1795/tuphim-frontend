...
import BasicDatabaseManager from './BasicDatabaseManager';
...
const AdvancedSearch = () => {
  ...
  const performSearch = async (page = 1, newFilters = filters, mode = searchMode) => {
    try {
      ...
      // Temporarily use simple API call to avoid blank page
      try {
        console.log('Using simple API call to avoid blank page');
  ...
  useEffect(() => {
    ...
    const initializeSearch = async () => {
      try {
        ...
        // Temporarily disable all database functionality to fix blank page
        console.log('🚀 Skipping all database functionality...');
        
        // Set basic stats without calling APIs
        setSearchStats({
          movies: 0,
          categories: 0,
          countries: 0,
        ...
        // Perform basic search without full database
