      ...
      <div className="max-w-8xl mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
          ...
          <div className="lg:col-span-1">
            <div className="bg-gray-800 rounded-xl p-6 fixed top-60 left-6 w-64 border-r border-gray-600 h-fit max-h-[calc(100vh-200px)] overflow-y-auto">
              <div className="mb-8">
                <h3 className="text-lg font-semibold text-white mb-3">Quản lý tài khoản</h3>
              </div>
              
              <nav className="space-y-3">
                <Link
                  to="/user/favorite"
                  className={`w-full flex items-center space-x-3 px-4 py-4 text-left transition-colors text-sm ${
              ...
              <div className="mt-10 pt-8 border-t border-gray-600">
                <div className="flex flex-col items-center mb-6">
                  ...
                  <div className="flex items-center space-x-2 mb-2">
                    <div className="text-white font-medium text-base">{user.fullName || user.username || 'Người dùng'}</div>
                    <svg className="w-5 h-5 text-yellow-400" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clipRule="evenodd" />
                    </svg>
                  </div>
                  <div className="text-gray-400 text-sm text-center">{user.email}</div>
                </div>
                <button className="w-full flex items-center justify-center space-x-2 px-4 py-3 bg-gray-700 hover:bg-gray-600 text-white rounded text-sm transition-colors">
                  <svg className="w-5 h-5 text-yellow-400" fill="currentColor" viewBox="0 0 20 20">
