  ...
  const loadFeaturedMovie = async () => {
    try {
      ...
      if (data.items && data.items.length > 0) {
        ...
        // Use fallback data with real movie images
        const fallbackMovie = {
          _id: 'fallback-1',
          ...
          content: 'Sau sự kiện tàn phá của Avengers: Infinity War, vũ trụ đang trong tình trạng đổ nát. Với sự giúp đỡ của các đồng minh còn lại, Avengers tập hợp một lần nữa để đảo ngược hành động của Thanos và khôi phục sự cân bằng cho vũ trụ.',
          year: 2019,
          quality: '4K',
        ...
        if (onFeaturedMovieChange) {
          onFeaturedMovieChange(fallbackMovie);
      }
        ...
        setSuggestedMovies(fallbackSuggestions);
      }
    } catch (error) {
      console.error('Error loading featured movie:', error);
      // Fallback to sample data with real movie images
      const fallbackMovie = {
        _id: 'sample',
        name: 'Avengers: Endgame',
        slug: 'avengers-endgame',
      ...
      // Sample suggested movies with real images
      setSuggestedMovies([
        {
          _id: 'sample1',
          name: 'Spider-Man: No Way Home',
      ...
      <section className="relative h-[80vh] min-h-[600px] -mt-20">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-black/70 via-black/40 to-black/10"></div>
               ...
               <div className="relative h-full">
                 ...
                 {/* Suggested Movies - Compact Style */}
                         ...
                         >
                           ...
                           {movie.episode_current && (
                             <div className="absolute top-0.5 right-0.5">
                               <span className="bg-blue-600 text-white text-[9px] px-1 py-0.5 rounded font-bold">
