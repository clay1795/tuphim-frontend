  ...
  const performSearch = async (page = 1, newFilters = filters, mode = searchMode) => {
    try {
      ...
      try {
        ...
        if (newFilters.keyword || newFilters.category || newFilters.country || newFilters.year || newFilters.type) {
          console.log('Using filtered search with:', newFilters);
          ...
          if (newFilters.keyword) searchParams.append('keyword', newFilters.keyword);
