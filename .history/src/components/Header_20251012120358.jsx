      ...
      <div className="px-2 sm:px-4 py-2">
        ...
        <input
          type="text"
                ...
                className="w-full px-3 py-2 pl-10 pr-12 bg-gray-800/50 border border-gray-700 rounded-l-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-yellow-400 focus:border-yellow-400 transition-all duration-300 backdrop-blur-sm text-sm"
          value={search}
          onChange={(e) => setSearch(e.target.value)}
              ...
              <button
                ...
                className="px-4 py-2 bg-gradient-to-r from-yellow-500 to-orange-500 hover:from-yellow-600 hover:to-orange-600 text-white rounded-r-lg transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-yellow-400"
                title="Tìm kiếm"
              >
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
