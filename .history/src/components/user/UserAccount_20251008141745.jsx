          ...
          <div className="text-center">
            <div className="relative inline-block">
              <img 
                ...
                alt="Avatar"
                className="w-24 h-24 rounded-full object-cover mx-auto border-4 border-gray-600"
              />
              <button
                onClick={() => setShowAvatarModal(true)}
                className="absolute bottom-0 right-0 bg-yellow-500 hover:bg-yellow-600 text-black rounded-full p-1 transition-colors"
              >
