  ...
  return (
    <>
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-2xl font-bold text-white mb-1">Phim yêu thích</h1>
          <p className="text-gray-400 text-sm">Danh sách phim bạn đã thêm vào yêu thích</p>
        </div>
        <div className="text-right">
          <div className="text-xl font-bold text-yellow-400">{favorites.length}</div>
