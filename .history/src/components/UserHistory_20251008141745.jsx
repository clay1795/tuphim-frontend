...
const UserHistory = () => {
  ...
  return (
    <div className="text-white">
      {/* Header */}
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-white">Danh sách xem tiếp</h1>
      </div>
      ...
      {loading ? (
        ...
        <>
          ...
          {/* Movie Grid - Single column layout for watch history */}
                  ...
                  <div className="w-full">
                    ...
                    <div className="aspect-[2/3] relative group mb-3">
                      ...
                      <button
                        ...
                        className="absolute top-2 right-2 w-6 h-6 bg-gray-800 hover:bg-red-600 text-white rounded flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-200"
                      >
                    ...
                    <div className="text-gray-400 text-xs mb-2">
                      Tập 1 • {Math.floor(progress * 1.2)}m / {formatDuration(90)}
                    </div>
                    ...
                    <div className="space-y-1">
                      ...
                      <p className="text-gray-400 text-sm line-clamp-1">
                        {item.originalName || item.movieName || 'Original Name'}
                      </p>
