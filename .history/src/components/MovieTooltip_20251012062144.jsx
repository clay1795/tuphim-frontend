  ...
  return (
    <div className="relative inline-block">
      ...
      {isVisible && (
        <div
          ref={tooltipRef}
          className="fixed z-50 w-96 bg-gray-900 rounded-xl shadow-2xl border border-gray-700 overflow-hidden movie-tooltip animate-in fade-in zoom-in-95 duration-300"
          style={{
            left: `${position.x}px`,
            top: `${position.y}px`,
            pointerEvents: 'auto',
          ...
          <div className="p-4 space-y-3">
            ...
            <div className="flex items-stretch space-x-2">
              ...
              <Link
                ...
                className="flex-grow bg-yellow-500 hover:bg-yellow-600 text-black font-bold py-2 px-6 rounded-lg transition-colors duration-200 flex items-center justify-center space-x-2"
              ...
              <button 
                ...
                className="flex-shrink-0 bg-gray-700 hover:bg-gray-600 text-white font-medium py-2 px-3 rounded-lg border border-gray-600 transition-colors duration-200 flex items-center justify-center space-x-1"
