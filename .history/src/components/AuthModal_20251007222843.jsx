          ...
          <form onSubmit={handleAuthSubmit} className="space-y-4">
            ...
            <div className="animate-fadeInUp">
              <input
                type="password"
                name="password"
                placeholder={isLogin ? "Mật khẩu" : "Mật khẩu (ít nhất 6 ký tự, có chữ hoa, thường và số)"}
            ...
            {/* Validation Help - chỉ hiển thị khi đăng ký */}
            {!isLogin && (
              <div className="text-xs text-gray-400 space-y-1 animate-fadeInUp">
                <div>📝 <strong>Hướng dẫn:</strong></div>
                <div>• Tên hiển thị: 2-50 ký tự</div>
                <div>• Email: Định dạng email hợp lệ</div>
                <div>• Mật khẩu: Ít nhất 6 ký tự, có chữ hoa, thường và số</div>
                <div>• Ví dụ mật khẩu: <span className="text-yellow-400">Test123</span></div>
              </div>
            )}
