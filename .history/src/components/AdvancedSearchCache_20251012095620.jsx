  ...
  return (
    <div className="min-h-screen bg-gray-900">
      ...
      <div className="container mx-auto px-6 py-8">
        ...
        <div className="space-y-6">
          ...
          {loading ? (
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-4 relative">
              {movies.map((movie, index) => (
                <div
                  key={movie._id || movie.id || index}
                  className="transform transition-all duration-300 hover:scale-105 relative z-10"
                  style={{
      ...
      <style>{`
        ...
        /* Ensure tooltip works properly in this component */
        .movie-tooltip {
        ...
        /* Ensure movie cards don't interfere with tooltip */
