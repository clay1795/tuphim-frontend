...
const MovieDetailRoPhim = () => {
  ...
  // Load all movies for series detection
  useEffect(() => {
    const loadAllMovies = async () => {
      try {
        // Load a large number of movies for series detection
        const result = await mongoMovieApi.getSeriesGroupedMovies(1, 1000);
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="flex flex-wrap border-b border-gray-700 mb-8">
              ...
              <button
                className={`px-4 py-3 text-base font-semibold whitespace-nowrap ${activeTab === 'series' ? 'text-yellow-400 border-b-2 border-yellow-400' : 'text-gray-400 hover:text-white'}`}
            ...
            <div className="min-h-[400px]">
              ...
              {activeTab === 'series' && (
                <div>
                  {/* 4. SERIES INFO - Thông tin series và các phần */}
                  <h3 className="text-xl font-bold text-white mb-6">Thông tin Series</h3>
                  
                  <SeriesInfo movie={movie} allMovies={allMovies} />
                </div>
              )}
