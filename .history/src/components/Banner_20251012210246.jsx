                   ...
                   <div className="px-3 py-3">
                     ...
                     <div className="flex justify-center space-x-2">
                       {suggestedMovies.slice(0, 6).map((movie, index) => (
                         ...
                         >
                           <div className="relative w-12 h-8 rounded overflow-hidden border border-white/30 hover:border-yellow-400 transition-all duration-300 group-hover:scale-110 bg-gray-800 shadow-lg">
                             <img
