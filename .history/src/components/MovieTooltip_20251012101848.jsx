...
const MovieTooltip = ({ movie, children }) => {
  ...
  const handleMouseEnter = () => {
    console.log('🎬 Tooltip Mouse Enter triggered for:', movie.name);
    ...
    const showTimeout = setTimeout(() => {
      console.log('🎬 Setting tooltip visible to true for:', movie.name);
      setIsVisible(true);
...
if (typeof document !== 'undefined') {
  ...
  // Add global tooltip override for AdvancedSearchCache
