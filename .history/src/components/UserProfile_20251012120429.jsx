        ...
        {activeTab === 'account' && (
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center mb-8">
              <h2 className="text-3xl font-bold text-white mb-2">Tài khoản cá nhân</h2>
              <p className="text-gray-400">Quản lý thông tin và cài đặt tài khoản của bạn</p>
            </div>
              ...
              <div className="text-center mb-8">
                <div className="relative inline-block">
                  ...
                  <button
                    ...
                    className="absolute -bottom-2 -right-2 bg-yellow-500 hover:bg-yellow-600 text-black rounded-full p-3 transition-all duration-200 shadow-lg hover:shadow-xl"
                ...
                <h3 className="text-xl font-semibold text-white mt-4">{profileForm.fullName || user.fullName || 'Người dùng'}</h3>
                ...
                <div className="md:col-span-2">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      value={user.email}
                      disabled
                      className="w-full pl-10 pr-4 py-3 bg-gray-700 border border-gray-600 rounded-xl text-gray-400 focus:outline-none focus:ring-2 focus:ring-yellow-400 focus:border-transparent"
                    />
                  </div>
                </div>
