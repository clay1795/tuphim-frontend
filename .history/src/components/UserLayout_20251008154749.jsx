...
const UserLayout = () => {
  ...
  return (
    <div className="flex h-screen bg-[#0d1017] text-white">
      {/* Sidebar */}
      <aside className="fixed top-0 left-0 h-screen w-[220px] bg-[#11151a] border-r border-[#1e2229] flex flex-col justify-between p-6">
        <div>
        ...
        <div className="border-t border-[#1f2430] pt-3 text-sm mt-4">
      ...
      {/* Main Content */}
      <main className="ml-[220px] flex-1 h-screen overflow-y-auto p-8">
        <Outlet />
      </main>
    </div>
  );
