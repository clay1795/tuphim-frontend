...
const SeparatedMovieCard = ({ movie, index = 0 }) => {
  ...
  return (
    <div className="group animate-fade-in relative" style={{ animationDelay: `${index * 0.1}s`, zIndex: 1 }}>
      {/* Poster Section */}
      <MovieTooltip movie={movie}>
        ...
        >
          <div className="relative overflow-hidden rounded-xl shadow-2xl hover:shadow-3xl transition-all duration-500 group-hover:scale-105 group-hover:-translate-y-2" style={{ zIndex: 1 }}>
            ...
            <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-500" style={{ zIndex: 2 }}>
              <div className="relative">
