  ...
  const loadFilterData = async () => {
    try {
      ...
      if (categoriesResult.success && Array.isArray(categoriesResult.data)) {
        ...
        console.error('Categories API failed or returned invalid data:', categoriesResult);
        setCategories([]);
      }
      ...
      if (countriesResult.success && Array.isArray(countriesResult.data)) {
        ...
        console.error('Countries API failed or returned invalid data:', countriesResult);
        setCountries([]);
      }
