  ...
  return (
    <div className="text-white">
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-3xl font-bold text-white mb-2">Xem tiếp</h1>
          <p className="text-gray-400">Lịch sử xem phim của bạn</p>
        </div>
        <div className="text-right">
          <div className="text-2xl font-bold text-yellow-400">{history.length}</div>
          <div className="text-sm text-gray-400">phim đã xem</div>
        </div>
      </div>
