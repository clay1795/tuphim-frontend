      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        {activeTab === 'account' && (
          <div>
            ...
            {/* DEBUG: NEW LAYOUT ACTIVE */}
            <div className="bg-red-500 text-white p-4 rounded-lg mb-6 text-center font-bold">
              🔥 LAYOUT MỚI: Avatar ở giữa Email và Tên hiển thị 🔥
            </div>
            
            {/* NEW LAYOUT - AVATAR BETWEEN EMAIL AND NAME */}
            <div className="space-y-6">
              ...
              {/* AVATAR SECTION - BETWEEN EMAIL AND NAME */}
              <div className="flex justify-center">
                <div className="relative">
                  ...
                  <button
                    ...
                    className="absolute bottom-0 right-0 bg-yellow-500 hover:bg-yellow-600 text-black rounded-full p-1.5 transition-colors"
