                         ...
                         >
                           <div className="relative w-16 h-16 rounded-full overflow-hidden border-2 border-white/20 hover:border-yellow-400 transition-all duration-300 group-hover:scale-110 bg-gray-800 shadow-lg">
                             ...
                             <div className="absolute top-1 left-1">
                               <span className="bg-red-600 text-white text-[10px] px-1 py-0.5 rounded font-bold">
                                 {movie.quality || 'HD'}
                               </span>
                             </div>
                             ...
                             {movie.episode_current && (
                               <div className="absolute top-1 right-1">
                                 <span className="bg-blue-600 text-white text-[10px] px-1 py-0.5 rounded font-bold">
                             ...
                             <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
                               <div className="text-white text-sm font-bold bg-yellow-500 px-3 py-1 rounded-full">
                                 Xem
                               </div>
                             </div>
                           </div>
