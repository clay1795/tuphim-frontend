                   ...
                   <div className="px-3 py-3">
                     ...
                     <div className="flex overflow-x-auto scrollbar-hide space-x-3 pb-2" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
                       {suggestedMovies.slice(0, 6).map((movie, index) => (
                         ...
                         >
                           <div className="relative w-20 h-14 rounded-lg overflow-hidden border-2 border-white/20 hover:border-yellow-400 transition-all duration-300 group-hover:scale-105 bg-gray-800 shadow-lg">
                             <img
                             ...
                             <div className="absolute top-1 left-1">
                               <span className="bg-red-600 text-white text-[9px] px-1 py-0.5 rounded font-bold shadow-lg">
                                 {movie.quality || 'HD'}
                               </span>
                             </div>
                             ...
                             {movie.episode_current && (
                               <div className="absolute top-1 right-1">
                                 <span className="bg-blue-600 text-white text-[9px] px-1 py-0.5 rounded font-bold shadow-lg">
                             ...
                             <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center rounded-lg">
                               <div className="text-white text-xs font-bold bg-yellow-500 px-2 py-1 rounded shadow-lg">
                                 Xem
                               </div>
                             </div>
                           </div>
                       ...
                       {suggestedMovies.slice(0, 6).map((movie, index) => (
                         ...
                         >
                           <div className="relative w-14 h-14 rounded-full overflow-hidden border-2 border-white/20 hover:border-yellow-400 transition-all duration-300 group-hover:scale-110 bg-gray-800 shadow-lg">
                             ...
                             {/* Quality Badge - Small for circle */}
                             <div className="absolute -top-1 -right-1">
                             ...
                             {/* Episode Badge - Small for circle */}
                             {movie.episode_current && (
