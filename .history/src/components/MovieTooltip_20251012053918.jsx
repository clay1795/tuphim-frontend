  ...
  return (
    <div className="relative inline-block">
      ...
      {isVisible && (
        <div
          ref={tooltipRef}
          className={`fixed z-50 w-96 bg-gray-900 rounded-xl shadow-2xl border border-gray-700 overflow-hidden tooltip-fade-in movie-tooltip ${isPinned ? 'pinned-tooltip' : ''}`}
          style={{
            left: `${position.x}px`,
            top: `${position.y}px`,
            pointerEvents: 'auto',
