    ...
    try {
      ...
      try {
        ...
        if (newFilters.keyword) {
          ...
          data = await simpleMovieApi.searchMovies(newFilters.keyword, searchOptions);
        } else {
          ...
          <div className="mt-6 flex flex-wrap gap-2">
            <button
              onClick={async () => {
                ...
                try {
                  const result = await instantSearchApi.instantSearch('action', { page: 1, limit: 5 });
            ...
            <button
              onClick={async () => {
                ...
                try {
                  const result = await instantSearchApi.getAllMovies({ page: 1, limit: 10 });
