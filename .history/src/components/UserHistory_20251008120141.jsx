  ...
  return (
    <div className="text-white">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-2xl font-bold text-white mb-1">Xem tiếp</h1>
          <p className="text-gray-400 text-sm">Lịch sử xem phim của bạn</p>
        </div>
        <div className="text-right">
          <div className="text-xl font-bold text-yellow-400">{history.length}</div>
