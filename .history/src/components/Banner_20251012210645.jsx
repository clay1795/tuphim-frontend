        ...
        <div className="absolute inset-0 bg-gradient-to-r from-black/70 via-black/40 to-black/10"></div>
               ...
               <div className="relative h-full">
                 ...
                 <div className="hidden lg:block absolute bottom-6 right-6 z-20 banner-suggestions">
                   <div className="bg-black/80 backdrop-blur-lg rounded-xl p-4 border border-white/30 shadow-2xl">
                     ...
                     <div className="flex space-x-2 justify-center">
                       {suggestedMovies.slice(0, 6).map((movie, index) => (
                         ...
                         >
                           <div className="relative w-20 h-12 rounded overflow-hidden border border-white/30 hover:border-yellow-400 transition-all duration-300 group-hover:scale-110 bg-gray-800 shadow-lg">
                             <img
                               src={movie.thumbnail_url || movie.thumb_url || getOptimizedImageUrl(movie.poster_url)}
                               alt={movie.name}
                               className="w-full h-full object-cover object-center"
                             ...
                             {/* Hover Overlay */}
                             <div className="absolute inset-0 bg-black/70 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center rounded">
