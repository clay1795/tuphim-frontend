      ...
      <section className="relative h-[50vh] sm:h-[60vh] md:h-[70vh] lg:h-[80vh] min-h-[350px] sm:min-h-[400px] md:min-h-[500px] lg:min-h-[600px] -mt-16 sm:-mt-20 banner-hero">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-black/70 via-black/40 to-black/10"></div>
               ...
               <div className="relative h-full">
                 ...
                 {/* Suggested Movies - Enhanced Style */}
                 <div className="absolute bottom-3 right-3 sm:bottom-6 sm:right-6 z-20 max-w-xs sm:max-w-sm banner-suggestions">
                   <div className="bg-black/80 backdrop-blur-lg rounded-xl sm:rounded-2xl p-2 sm:p-4 border border-white/30 shadow-xl sm:shadow-2xl">
                     <h3 className="text-white text-xs sm:text-sm font-semibold mb-2 sm:mb-3 text-center">Đề xuất cho bạn</h3>
                     <div className="grid grid-cols-3 gap-1 sm:gap-2">
                       {suggestedMovies.slice(0, 3).map((movie, index) => (
                         ...
                         >
                           <div className="relative w-full h-16 sm:h-20 md:h-24 rounded-md sm:rounded-lg overflow-hidden border-2 border-white/20 hover:border-yellow-400 transition-all duration-300 group-hover:scale-102 sm:group-hover:scale-105 bg-gray-800">
                             <img
