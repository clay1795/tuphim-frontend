...
const UserWatchlist = () => {
  ...
  return (
    <div className="container mx-auto px-6">
      {/* Header */}
      <div className="mb-6">
        <h1 className="text-2xl font-semibold">Xem sau</h1>
      </div>
      ...
      {loading ? (
        <div className="text-center py-12">
          <div className="animate-spin rounded-full h-12 w-12 border-4 border-gray-700 border-t-red-500 mx-auto mb-4"></div>
