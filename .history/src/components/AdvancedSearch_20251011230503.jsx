        ...
        if (newFilters.keyword) {
          ...
          for (let currentPage = 1; currentPage <= pagesToFetch; currentPage++) {
            ...
            if (result.data && result.data.items) {
              ...
              // Progressive loading: Show movies immediately after each page
              if (currentPage <= 10 && allMovies.length > 0) {
                console.log(`🚀 Progressive loading: Showing ${allMovies.length} movies after page ${currentPage}`);
