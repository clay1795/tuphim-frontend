    ...
    try {
      ...
      if (cachedData && page === 1) {
        try {
          ...
          // Cache data corrupted, fetching fresh data
        }
      }
    ...
    <div className="min-h-screen bg-gray-900">
      ...
      <style>{`
        @keyframes fadeInUp {
         ...
         /* Force all other elements to have lower z-index, except header */
         *:not(header):not(.header):not([class*="header"]):not([class*="sticky"]) {
           z-index: auto !important;
         }
         
         /* Ensure header stays on top - more specific selectors */
         header, .header, [class*="header"], [class*="sticky"], 
         [class*="top-0"], [class*="z-"], [class*="fixed"] {
           z-index: 9999 !important;
         }
         
         /* Specifically target movie grid and cards */
         .grid, .movie-card, .movie-item, [class*="movie"] {
           z-index: 1 !important;
           position: relative !important;
         }
         
         /* Force header to be above everything except tooltip */
         div[class*="sticky"], div[class*="top-0"], div[class*="z-"] {
           z-index: 9999 !important;
         }
         
         /* Override any conflicting z-index on movie components */
         .group, .animate-fade-in, .relative {
           z-index: 1 !important;
         }
         
         /* Specific override for header container */
         div[class*="sticky"][class*="top-0"][class*="z-"] {
           z-index: 9999 !important;
