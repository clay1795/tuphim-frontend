            ...
            <div className="relative w-full h-full">
              ...
              {!isPlaying && (
                <div className="absolute inset-0 flex items-center justify-center bg-black/40 backdrop-blur-sm">
                  <button 
                    onClick={handlePlayPause}
                    className="w-20 h-20 bg-white/90 hover:bg-white rounded-full flex items-center justify-center transition-all duration-300 transform hover:scale-110 shadow-2xl group"
                  >
                    <svg className="w-8 h-8 text-black ml-1 group-hover:scale-110 transition-transform" fill="currentColor" viewBox="0 0 24 24">
              ...
              {buffering && (
                <div className="absolute inset-0 flex items-center justify-center bg-black/60">
                  <div className="text-center">
                    <div className="w-12 h-12 border-3 border-blue-500/30 border-t-blue-500 rounded-full animate-spin mb-3"></div>
          ...
          <div className="flex-1 overflow-y-auto p-6">
            {episodes.map((server, serverIndex) => (
              <div key={serverIndex} className="mb-6">
                <h4 className="text-white font-medium mb-3 text-sm uppercase tracking-wide text-gray-300">
                  {server.server_name}
                </h4>
