...
const VideoPlayer = () => {
  ...
  const [duration] = useState(1465); // 24:25 in seconds
  ...
  }, [showEpisodeList, showKeyboardHelp, currentTime, duration, isMuted, handlePlayPause, handleForward, handleRewind, handleVolumeToggle]);

  const handlePlayPause = () => {
    setIsPlaying(!isPlaying);
    // Thực tế sẽ điều khiển video element hoặc iframe
  ...
  const handleVolumeToggle = () => {
    setIsMuted(!isMuted);
    console.log('Volume toggle, muted:', !isMuted);
  };
