...
const MovieDetailPage = () => {
  ...
  const { movieDetail, loading, error, fetchMovieDetail } = useMovieDetailContext();
    ...
    return (
      <div className="min-h-screen bg-gray-900 flex items-center justify-center">
        <div className="text-center text-white">
          <div className="text-xl mb-4">Không tìm thấy phim</div>
          <button
            onClick={() => navigate('/')}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2">
            <VideoPlayer
              movieData={{
                ...movieDetail,
                embedUrl: movieDetail.embedUrl || `https://goatembed.com/${movieId}?version=1`
              }}
