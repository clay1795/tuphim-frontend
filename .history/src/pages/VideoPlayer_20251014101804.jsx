...
const VideoPlayer = () => {
  ...
  const setAudio = (type) => {
    setAudioType(type);
    toast.success(type === "subtitle" ? "Phụ đề" : "Thuyết minh");
  };
      ...
      <div className="sticky top-0 z-50 bg-[#0E0E18]/95 backdrop-blur-md border-b border-[#272A3A]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <button
              onClick={() => navigate(`/phim/${slug}`)}
              className="flex items-center space-x-3 text-[#F5F5F5] hover:text-[#FFC94A] transition-all duration-300 group"
            >
            ...
            <div className="flex gap-2">
              <button
                ...
                className={`px-3 py-1 rounded-full ring-1 text-xs ${
                  audioType === "subtitle" ? "bg-[#272A3A]" : "bg-transparent"
                } ring-[#44475A]`}
              >
                Phụ đề
              </button>
              <button
                ...
                className={`px-3 py-1 rounded-full ring-1 text-xs ${
                  audioType === "dub" ? "bg-[#272A3A]" : "bg-transparent"
                } ring-[#44475A]`}
              >
                Thuyết minh
              </button>
