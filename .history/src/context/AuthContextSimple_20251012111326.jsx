...
const AuthProvider = ({ children }) => {
  ...
  const changePassword = async (passwordData) => {
    try {
      ...
      const response = await fetch(`${API_CONFIG.getApiUrl()}/auth/change-password`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
  ...
  const updateProfile = async (profileData) => {
    try {
      const response = await fetch(`${API_CONFIG.getApiUrl()}/users/profile`, {
        method: 'PUT',
  ...
  const addToWatchlist = async (movieData) => {
    try {
      const response = await fetch('${API_CONFIG.getApiUrl()}/users/watchlist', {
        method: 'POST',
        headers: getAuthHeaders(),
  ...
  const removeFromWatchlist = async (movieId) => {
    try {
      const response = await fetch(`${API_CONFIG.getApiUrl()}/users/watchlist/${movieId}`, {
        method: 'DELETE',
        headers: getAuthHeaders(),
      });
  ...
  const addToFavorites = async (movieData) => {
    try {
      const response = await fetch('${API_CONFIG.getApiUrl()}/users/favorites', {
        method: 'POST',
        headers: getAuthHeaders(),
        body: JSON.stringify(movieData),
      });
  ...
  const removeFromFavorites = async (movieId) => {
    try {
      const response = await fetch(`${API_CONFIG.getApiUrl()}/users/favorites/${movieId}`, {
        method: 'DELETE',
        headers: getAuthHeaders(),
      });
  ...
  const addToHistory = async (movieData) => {
    try {
      const response = await fetch('${API_CONFIG.getApiUrl()}/users/history', {
        method: 'POST',
        headers: getAuthHeaders(),
        body: JSON.stringify(movieData),
      });
  ...
  const getUserStats = async () => {
    try {
      const response = await fetch('${API_CONFIG.getApiUrl()}/users/stats', {
        method: 'GET',
        headers: getAuthHeaders(),
      });
  ...
  const forgotPassword = async (email) => {
    try {
      ...
      const response = await fetch('${API_CONFIG.getApiUrl()}/auth/forgot-password', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const resetPassword = async (token, newPassword) => {
    try {
      ...
      const response = await fetch('${API_CONFIG.getApiUrl()}/auth/reset-password', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
