...
async function testRemoveAndAddMovie() {
  try {
    console.log('Testing remove and add movie with English name...');
    ...
    console.log('\n2. Removing existing movie...');
    const removeResponse = await axios.delete('http://localhost:3001/api/users/favorites/test-movie-123', {
      headers: {
    ...
    // Add movie with sample data
    console.log('\n3. Adding movie with sample data...');
    const testMovieData = {
