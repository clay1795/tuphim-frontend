...
async function testRemoveAndAddMinimal() {
  try {
    console.log('Testing remove and add with minimal data...');
    ...
    console.log('\n1. Removing existing movie...');
    try {
      await axios.delete('http://localhost:3001/api/users/favorites/test-minimal-001', {
        headers: {
      ...
      console.log('⚠️  Movie not found or already removed');
    }
