...
### **Giai đoạn 1-2: Foundation & Performance (KKPhim API)**
| Service | Cost | Purpose |
|---------|------|---------|
| MongoDB Atlas | $9/tháng | User data database |
| Redis Cloud | $7/tháng | KKPhim API caching |
| Backend Hosting | $10/tháng | API proxy server |
| **Subtotal** | **$26/tháng** | |
